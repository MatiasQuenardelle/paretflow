...
export const translations = {
  en: {
    ...
    plans: {
      ...
      getStarted: 'Get started by creating your roadmap',
      editPlan: 'Edit Plan',
      ...
      brandEcosystem: 'Brand Ecosystem',
      ...
      pushedToTasks: 'Added to tasks',
      weeklySchedule: 'Weekly Schedule',
      generateTasks: 'Generate This Week\'s Tasks',
      ...
      firstSevenDays: 'First 7 days action items',
      addQuickStartItem: 'Add item',
  ...
  es: {
    ...
    plans: {
      title: 'Planes',
      subtitle: 'Tu hoja de ruta hacia el éxito',
      createPlan: 'Crear Plan',
      createYourPlan: 'Crea tu plan',
      getStarted: 'Comienza creando tu hoja de ruta',
      ...
      brandEcosystem: 'Ecosistema de Marca',
      overallProgress: 'Progreso General',
      phaseTimeline: 'Línea de Tiempo',
      addPhase: 'Agregar fase',
      addMilestone: 'Agregar hito',
      addItem: 'Agregar elemento',
      pushToTasks: 'Enviar a Tareas',
      pushedToTasks: 'Agregado a tareas',
      weeklySchedule: 'Horario Semanal',
      generateTasks: 'Generar Tareas de Esta Semana',
      tasksGenerated: 'tareas generadas',
      addBlock: 'Agregar bloque',
      platformStrategy: 'Estrategia de Plataformas',
      hoursPerWeek: 'h/semana',
      totalHours: 'Total de horas',
      addPlatform: 'Agregar plataforma',
      contentPillars: 'Pilares de Contenido',
      addPillar: 'Agregar pilar',
      quickStartChecklist: 'Lista de Inicio Rápido',
      firstSevenDays: 'Acciones para los primeros 7 días',
      addQuickStartItem: 'Agregar elemento',
